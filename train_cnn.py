...
#    print("Loading training batch")
    ...
    Num_abnormal = 769  # Total number of abnormal videos in Training Dataset.
...
output_dir='/home/keval/Desktop/Outputs/out/'
...
for it_num in range(num_iters):
    print(it_num,total_iterations)
    AbnormalPath = "Train_Data_Anomaly/" #os.path.join(AllClassPath, All_class_files[0])  # Path of abnormal already computed C3D features
    NormalPath = "Train_Data_Nominal/"   #os.path.join(AllClassPath, All_class_files[1])    # Path of Normal already computed C3D features
